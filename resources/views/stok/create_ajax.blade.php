    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Stok Barang Masuk</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input value="{{ date('Y-m-d\TH:i') }}" type="datetime-local" name="stok_tanggal" id="stok_tanggal" class="form-control" required>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) {
                            ...
                            tableStok.ajax.reload(); // Reload table_stok
                        } else {
                            $('.error-text').text('');
